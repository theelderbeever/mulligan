...
pub use crate::backoff::{Backoff, Exponential, Fixed, Linear};
pub use crate::jitter::{Decorrelated, Equal, Full, Jitter, NoJitter};
    ...
    Cond: Fn(&Result<T, E>) -> bool,
{
    Mulligan {
        ...
        jitterable: crate::jitter::NoJitter,
        max: None,
        before_attempt: None,
        after_attempt: None,
    ...
    Back: crate::backoff::Backoff,
{
    ...
    pub fn full_jitter(self) -> Mulligan<'a, T, E, Cond, crate::jitter::Full, Back> {
        Mulligan {
            stop_after: self.stop_after,
            until: self.until,
            backoff: self.backoff,
    ...
    pub fn equal_jitter(self) -> Mulligan<'a, T, E, Cond, crate::jitter::Equal, Back> {
        Mulligan {
            stop_after: self.stop_after,
            until: self.until,
            backoff: self.backoff,
    ...
    pub fn decorrelated_jitter(
        self,
        base: Duration,
    ) -> Mulligan<'a, T, E, Cond, crate::jitter::Decorrelated, Back> {
        Mulligan {
            stop_after: self.stop_after,
            until: self.until,
            backoff: self.backoff,
